...
gd = GetData()
x, y = gd.split_sen()
x1 = x[:3988] # 3988   --- 3589train 399test
y1 = y[:3988]
x0 = x[3988:] # 3589   ---- 3230train 359test
y0 = y[3988:]


train_x = x0[:3589] + x1[:3230]
train_y = y0[:3589] + y1[:3230]
...
test_x = x0[3589:] + x1[3589:]
test_y = y0[3589:] + y1[3589:]
